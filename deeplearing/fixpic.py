...
def fix(path_d,mask_image):
    ...
    model.netEN.module.load_state_dict(torch.load("./deeplearing/checkpoints/Mutual Encoder-Decoder/56_net_EN.pth",map_location={'cuda:2':'cuda:0'})['net'])
    model.netDE.module.load_state_dict(torch.load("./deeplearing/checkpoints/Mutual Encoder-Decoder/56_net_DE.pth",map_location={'cuda:2':'cuda:0'})['net'])
    model.netMEDFE.module.load_state_dict(torch.load("./deeplearing/checkpoints/Mutual Encoder-Decoder/56_net_MEDFE.pth",map_location={'cuda:2':'cuda:0'})['net'])
    ...
    results_dir_test_gt = r'./deeplearing/image/PT'
