import argparse
import os
from deeplearing.util import util
import torch
...
class BaseOptions():
    ...
    def initialize(self, parser):
        # 修改之后的
        # parser.add_argument('--st_root', type=str, default=r'/data3/qianjiale_dataset/psv_256_new_st',
        #                     help='path to structure images')
        parser.add_argument('--st_root', type=str, default=r'E:/data/celeba-256-test-PT/GT',
                            help='path to structure images')
        parser.add_argument('--de_root', type=str, default=r'E:/deeplearing/pyqtv2/deeplearing/image/test_celeba',
                            help='path to detail images (which are the groundtruth)')
        # parser.add_argument('--de_root', type=str, default=r'/data3/qianjiale_dataset/place2_30000_val',
        #                     help='path to detail images (which are the groundtruth)')
        # parser.add_argument('--de_root', type=str, default=r'/data3/qianjiale_dataset/place2_30000_train',
        #                     help='path to detail images (which are the groundtruth)')
        # parser.add_argument('--de_root', type=str, default=r'/data3/qianjiale_dataset/Paris StreetView Dataset/paris_eval/paris_eval_gt', help='path to detail images (which are the groundtruth)')
        # parser.add_argument('--mask_root', type=str, default=r'/data3/qianjiale_dataset/testing_mask/block', help='path to mask, we use the datasetsets of partial conv hear')
        parser.add_argument('--mask_root_2', type=str, default=r'E:/data/celeba-256-test-PT/mask_2',
                            help='path to mask, we use the datasetsets of partial conv hear')
        parser.add_argument('--mask_root', type=str, default=r'E:/data/celeba-256-test-PT/mask',
                            help='path to mask, we use the datasetsets of partial conv hear')
        #修改之前的
